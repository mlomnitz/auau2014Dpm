...
if ( ! -e ${baseFolder}/starSubmit/submitPicoDpmMaker.xml ) then
    echo "XML submitPicoDpmMaker.xml does not exist"
    exit
else
    ln -sf ${baseFolder}/starSubmit/submitPicoDpmMaker.xml 
endif
...
set hackTemplate=submitPicoDpmMaker_temp.xml 

if ( -e submitPicoDpmMaker_temp.xml  ) then
    rm submitPicoDpmMaker_temp.xml 
endif 
...
tail -n +2 submitPicoDpmMaker.xml >> $hackTemplate

star-submit -u ie $hackTemplate

#star-submit-template -template submitPicoDpmMaker.xml -entities listOfFiles=${input},basePath=${baseFolder},prodId=${productionId},mMode=${makerMode},treeName=${treeName},rootMacro=${rootMacro}
